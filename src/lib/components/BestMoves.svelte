<script lang="ts">
	...
	const formatPosition = (move: Move) =>
		`(${move.row}, ${move.col}) ${move.direction === "H" ? "Across" : "Down"}`;
</script>

<div
	data-testid="best-moves-container"
